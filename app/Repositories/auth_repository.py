...
class AuthRepository:
    ...
    def user_sign_in(self,data):
        ...
        if domain == "cakery_admin.com":
            user = Admin.query.filter_by(adminemail=customer_email).first()
            role = "admin"
        elif domain == "cakery_baker.com":
            user = BakeryUser.query.filter_by(bakeryemail=customer_email).first()
            role = "baker"
            name = user.firstname
            ...
            user = DeliveryUser.query.filter_by(deliveryemail=customer_email).first()
            role = "delivery"
            name = user.firstname
        else:
            return {
